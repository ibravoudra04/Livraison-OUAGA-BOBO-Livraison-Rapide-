...
export default function Drawer({ id, isOpen, onClose, title, children, cardStyle }: DrawerProps) {
  return (
    <div id={id} className={`location-portal-overlay ${isOpen ? 'open' : ''}`} style={{ zIndex: 2000 }}>
      <div className="location-portal-card" style={{ maxHeight: '90vh', overflowY: 'auto', padding: '24px', ...cardStyle }}>
