...
export default function Home() {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100dvh', width: '100%', overflow: 'hidden' }}>
      ...
      />
      {showWelcome && (
        <footer style={{ flexShrink: 0, width: '100%', display: 'flex', justifyContent: 'center', zIndex: 1000, background: 'rgba(255,255,255,0.95)', borderTop: '1px solid rgba(0,0,0,0.05)', padding: '10px 16px' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', width: '100%', maxWidth: '540px' }}>
            <button 
              ...
              style={{ display: 'inline-flex', alignItems: 'center', gap: '5px', color: '#66554D', background: 'none', border: 'none', cursor: 'pointer', textDecoration: 'none', fontWeight: '600', fontSize: '0.80rem', padding: '5px 8px', borderRadius: '16px', transition: 'all 0.2s' }}
            >
            ...
            <a 
              href={`https://wa.me/?text=${encodeURIComponent("Découvrez Livraison Rapide, l'application pour trouver des livreurs fiables en temps réel à Ouagadougou et Bobo-Dioulasso ! 🏍️📦\nhttps://livraisonrapide.app")}`}
              target="_blank"
              rel="noopener noreferrer"
              style={{ display: 'inline-flex', alignItems: 'center', gap: '5px', color: '#25D366', background: 'rgba(37, 211, 102, 0.08)', border: '1px solid rgba(37, 211, 102, 0.25)', cursor: 'pointer', textDecoration: 'none', fontWeight: '700', fontSize: '0.80rem', padding: '5px 10px', borderRadius: '16px', transition: 'all 0.2s' }}
            >
