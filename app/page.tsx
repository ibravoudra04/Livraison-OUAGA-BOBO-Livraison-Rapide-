...
export default function Home() {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100dvh', width: '100%', overflow: 'hidden' }}>
      ...
      />
      {showWelcome && (
        <footer style={{ flexShrink: 0, width: '100%', display: 'flex', justifyContent: 'center', zIndex: 1000, background: 'rgba(255,255,255,0.95)', borderTop: '1px solid rgba(0,0,0,0.05)', padding: '12px 16px' }}>
          <div style={{ display: 'flex', gap: '16px', alignItems: 'center', justifyContent: 'center', flexWrap: 'wrap' }}>
            <button 
              onClick={() => setIsSupportDrawerOpen(true)} 
              style={{ display: 'flex', alignItems: 'center', gap: '6px', color: '#66554D', background: 'none', border: 'none', cursor: 'pointer', textDecoration: 'none', fontWeight: '600', fontSize: '0.85rem', padding: '6px 12px', borderRadius: '20px', transition: 'all 0.2s' }}
            >
            ...
            <a 
              ...
              style={{ display: 'flex', alignItems: 'center', gap: '6px', color: '#25D366', background: 'rgba(37, 211, 102, 0.1)', border: '1px solid rgba(37, 211, 102, 0.3)', cursor: 'pointer', textDecoration: 'none', fontWeight: '700', fontSize: '0.85rem', padding: '6px 14px', borderRadius: '20px', transition: 'all 0.2s' }}
            >
