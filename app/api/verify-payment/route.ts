          ...
          parts: [
            ...
            },
            {
              text: "Tu es un agent de vérification de reçus de paiement Orange Money pour le Burkina Faso.\n" +
                    ...
                    "}\n" +
                    "Si le destinataire ou le numéro de réception ne correspond pas à OUEDRAOGO IBRAHIM / 67370909, ou si l'image n'est pas une confirmation de transfert finalisée, renvoie is_orange_money: false."
            }
          ]
        }
      ],
